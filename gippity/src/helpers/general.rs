...
pub const BACKEND_CODE_DIR: &str = "/Users/HP/Code/Desktop/Rust/autogpt-web-builder-gippity-rust-main/autogpt-web-builder-gippity-rust-main/website/backend";
pub const FRONTEND_CODE_DIR: &str = "/Users/HP/Code/Desktop/Rust/autogpt-web-builder-gippity-rust-main/autogpt-web-builder-gippity-rust-main/website/frontend";
// C:\Users\HP\Desktop\Rust\autogpt-web-builder-gippity-rust-main\autogpt-web-builder-gippity-rust-main\website\backend
...
pub async fn ai_task_request(
    ...
    // Get agent response
    let agent_response_res: Result<String, Box<dyn std::error::Error + Send>> =
    ...
    let agent_response: String = match agent_response_res {
        ...
        // Try again if error
        Err(_) => call_gpt(vec![func_message.clone()])
            .await
...
pub fn save_api_endpoints(api_endpoints: &String) {
    ...
    fs::write(path, api_endpoints).expect("Something went wrong saving the file");
}
